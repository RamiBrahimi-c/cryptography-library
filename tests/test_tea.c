...
int main() {
    ...
    TEST_ON_TEXT_ENCRYPTION(tea,input,output  ,input_len ,key  , key_len, TeaKey ) ;
    // TEST_ON_TEXT_ENCRYPTION_MODE(tea ,cbc ,input,output , iv ,input_len ,key  , key_len, TeaKey) ;
    ...
    // do a decryption : 
    // TEST_ON_TEXT_DECRYPTION_MODE(tea , cbc ,output,output2 , iv,input_len,key  , key_len, TeaKey) ;
    TEST_ON_TEXT_DECRYPTION(tea ,output,output2 ,input_len,key  , key_len, TeaKey) ;
