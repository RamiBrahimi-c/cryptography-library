...
int main() {
    ...
    // TEST_ON_TEXT_ENCRYPTION(redpike,input,output  ,input_len ,key  , key_len, RedpikeKey ) ;
    TEST_ON_TEXT_ENCRYPTION_MODE(redpike ,cbc ,input,output , iv ,input_len ,key  , key_len, RedpikeKey) ;
    ...
    // do a decryption : 
    TEST_ON_TEXT_DECRYPTION_MODE(redpike , cbc ,output,output2 , iv,input_len,key  , key_len, RedpikeKey) ;
    // TEST_ON_TEXT_DECRYPTION(redpike ,output,output2 ,input_len,key  , key_len, RedpikeKey) ;
